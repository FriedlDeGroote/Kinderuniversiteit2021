...
function [err, FT] = ForceEquilibrium_FtildeState_Tlin(a,fse,dfse,lMT,vMT,params,Fvparam,Fpparam,Faparam,Atendon)
...
% Equilibrium between muscle and tendon forces: better numerical conditions
% if normalized values
% err =  FM.*cos_alpha-FT;
err =  (Fce+Fpe).*cos_alpha-fse;
